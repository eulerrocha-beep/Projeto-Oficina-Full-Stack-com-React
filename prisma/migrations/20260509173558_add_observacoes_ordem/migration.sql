/*
  ...
  - You are about to drop the column `observacoes` on the `OrdemServico` table. All the data in the column will be lost.
  ...
  - Added the required column `observacao` to the `OrdemServico` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_OrdemServico" ("clienteId", "createdAt", "id", "status", "valor", "veiculoId") SELECT "clienteId", "createdAt", "id", "status", "valor", "veiculoId" FROM "OrdemServico";
